...
# esx.cgi -
#
# Get/set EC-CiscoUCS configuration info for UI
#
...
################################
# getCfgList - Return the list of configurations from CiscoUCS
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/ucs_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
        my $url = $gcfg->getCol("$cfg/ucs_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
