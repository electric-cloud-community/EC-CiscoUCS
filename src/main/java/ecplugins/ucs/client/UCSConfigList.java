...
// UCSConfigList.java --
//
// UCSConfigList.java is part of ElectricCommander.
//
...
public class UCSConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, UCSConfigInfo> m_configInfo =
        new TreeMap<String, UCSConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new UCSConfigInfo(configUrl));
    }
    ...
    private class UCSConfigInfo
    {
        ...
        public UCSConfigInfo(String url)
        {
            m_url = url;
        }
    }
