...
/**
 * EC-CiscoUCS Configuration List.
 */
    ...
    extends ListBase
{
    ...
    public ConfigurationList()
    {
        ...
        super("ecgc", "Cisco UCS Configurations", "All Configurations");
        m_configList = new UCSConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        Loader loader = new UCSConfigListLoader(
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-CiscoUCS/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            ClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Cisco UCS configuration '"
                            + configName + "'?") {
