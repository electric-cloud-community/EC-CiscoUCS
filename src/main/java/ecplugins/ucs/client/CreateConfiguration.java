...
/**
 * Create Cisco UCS Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    public CreateConfiguration()
    {
        ...
        super("New Cisco UCS Configuration", "Cisco UCS Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-CiscoUCS"
                + "/project/ui_forms/UCSCreateConfigForm");
        loader.load();
        clearStatus();
    }
